_base_ = '../detr/detr_r101_8xb2-500e_coco.py'
...
# 기타 설정 
auto_scale_lr = dict(base_batch_size=8)  # 1 GPU * 8 samples

work_dir = './work_dirs/detr_r101_8xb2-500e'

# wandb init arguments : 필요 없으면 모두 None으로 해도됨 
run_name = 'detr_r101_8xb2-500e_coco'
tags = ['dter', 'resnet101', '500epoch'] # 원하는 태그 설정
notes = 'training detr to compare with co-detr' # 해당 run에 대한 설명

default_hooks = dict(
    checkpoint=dict(type='CheckpointHook', interval=30, max_keep_ckpts=3),
)
